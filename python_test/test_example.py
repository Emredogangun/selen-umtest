...
class TestAmazonExample(WebDriverBase):
    ...
    def __init__(self):
       ...
       #kitap 1
        ...
        time.sleep(2)
        self.driver.find_element_by_xpath("//*[@id='9d4b500b-9411-46e0-b7ae-f6e3c657f5f2']/div/div/ul/li[1]/div/a/figure/img").click()
        time.sleep(2)
        ...
        self.driver.find_element_by_css_selector("#buttonProductSearch").click()
        time.sleep(5)
        self.driver.find_element_by_xpath("//*[@id='9d4b500b-9411-46e0-b7ae-f6e3c657f5f2']/div/div/ul/li[2]/div/a/figure/img").click()
        time.sleep(2)
        self.driver.find_element_by_xpath("/html/body/div[2]/main/div[4]/section[1]/div[4]/div/div[4]/div[1]/div[7]/ul/li[2]/a").click()
        time.sleep(5)
